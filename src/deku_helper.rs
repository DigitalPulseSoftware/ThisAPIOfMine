...
pub fn write_key<W: std::io::Write + std::io::Seek>(
    writer: &mut Writer<W>,
...
pub fn write_str<W: std::io::Write + std::io::Seek>(
    writer: &mut Writer<W>,
    value: &str,
) -> Result<(), DekuError> {
...
pub fn write_vec_str<W: std::io::Write + std::io::Seek>(
    writer: &mut Writer<W>,
    value: &Vec<String>,
) -> Result<(), DekuError> {
...
pub fn write_uuid<W: std::io::Write + std::io::Seek>(
    writer: &mut Writer<W>,
    value: &Uuid,
) -> Result<(), DekuError> {
